...
INSERT INTO "new_Book" ("author", "binId", "categoryId", "coverImageUrl", "createdAt", "id", "isbn", "qualifierId", "resourceCategoryId", "resourceId", "status", "statusNote", "statusUpdatedAt", "title", "totalCopies", "updatedAt") SELECT "author", "binId", "categoryId", "coverImageUrl", "createdAt", "id", "isbn", "qualifierId", "resourceCategoryId", "resourceId", "status", "statusNote", "statusUpdatedAt", "title", "totalCopies", "updatedAt" FROM "Book";
DROP TABLE "Book";
