...
INSERT INTO "new_Book" ("author", "binId", "categoryId", "coverImageUrl", "createdAt", "id", "isbn", "qualifierId", "title", "totalCopies", "updatedAt") SELECT "author", "binId", "categoryId", "coverImageUrl", "createdAt", "id", "isbn", "qualifierId", "title", "totalCopies", "updatedAt" FROM "Book";
DROP TABLE "Book";
